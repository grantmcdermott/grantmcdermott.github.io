...
*The tutorial below has been on my [GitHub](https://github.com/grantmcdermott/rstudio-compute-engine){:target="_blank"} for a while. I don't have a good reason for adding it to this blog as well (and at this stage), but here it is all the same.*
